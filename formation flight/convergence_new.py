...
#       wake:               free
#       cycles:             1
#       panel aspect ratio: 4 (2 and 2 spanwise panels)
#       chordwise panels:   4
# 1% Convergence:
#   1 Airplane:
#       wake:               free
#       cycles:             3
#       panel aspect ratio: 4 (3 and 3 spanwise panels)
#       chordwise panels:   6
#   3 Airplanes:
#       wake:               free
#       cycles:             3
#       panel aspect ratio: 1 (12 and 11 spanwise panels)
#       chordwise panels:   6
#   5 Airplanes:
#       wake:               ?
#       cycles:             ?
#       panel aspect ratio: ? (? and ? spanwise panels)
#       chordwise panels:   ?
...
if not single_flap:
    ...
    for airplane_id in range(num_airplanes):
        ...
        this_moment = moment_coefficients[
            converged_wake_id,
            : converged_length_id + 2,
            converged_ar_id,
            converged_chord_id,
